...
class _ProductDetailsScreenState extends ConsumerState<ProductDetailsScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: FutureBuilder(
        future: ref.watch(productControllerProvider).getProduct(widget.productID),
        builder: (context,snapshot) {
          return snapshot.hasData ? Column(
            children: [
              Card(
                ...
                child: Image.asset(
                  snapshot.data!.productImageUrls.first,
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        ...
                        Row(
                          children:
                              snapshot.data!.categories.map((e) => Text("#$e ")).toList(),
                        )
                      ],
          ...
          ) : Center(child: Text("There is no product to show!"),);
        }
      ),
    );
  }
